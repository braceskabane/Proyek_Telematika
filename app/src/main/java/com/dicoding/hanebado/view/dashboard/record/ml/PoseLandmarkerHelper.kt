...
class PoseLandmarkerHelper(context: Context) {
    ...
    init {
        val options = PoseDetectorOptions.Builder()
            ...
            .build()
        poseDetector = com.google.mlkit.vision.pose.PoseDetection.getClient(options)
    }

    /**
     * Fungsi untuk memproses frame dari CameraX.
     * @param imageProxy Frame dari CameraX.
     * @param onPoseDetected Callback untuk pose yang berhasil dideteksi.
     * @param onError Callback untuk kegagalan deteksi.
     */
        ...
        if (mediaImage != null) {
            ...
            poseDetector.process(inputImage)
                ...
                .addOnCompleteListener {
                    imageProxy.close() // Pastikan frame dilepas setelah diproses
                }
        } else {
            imageProxy.close()
        }
