...
package com.dicoding.hanebado.view.dashboard.record.classification;

import static com.dicoding.hanebado.view.dashboard.record.classification.PoseEmbedding.getPoseEmbedding;
